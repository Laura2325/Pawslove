...
function camposIncompletos() {
    Swal.fire({
        ...
        allowEnterKey: true,
        customClass: {
            popup: 'pawslove-popup', // Clase para el contenedor
            title: 'pawslove-title'  // Clase para el título
        }
    });
    return;
}
...
function correoInvalido(email) {
    Swal.fire({
        title: 'Error de formato',
        text: `El correo electrónico ${email} no tiene un formato válido.`,
        icon: 'error',
        allowEnterKey: true,
        allowEscapeKey: true,
        allowOutsideClick: true,
...
function loginCorrecto(usuarioEncontrado) {
    Swal.fire({
        ...
        willClose: () => {
            ...
            usuarioEncontrado.tipo == 'Administrador Principal' ? window.location.replace('../paginas_admin/admin.html') : window.location.replace('index.html');
        }
    });
}
...
function alertaEmailNoRegistrado(){
    Swal.fire({
        icon: 'error',
        title: 'Error de autenticación',
        text: 'El correo electrónico no está registrado. Por favor, verifica tus datos o regístrate.',
        allowEnterKey: true,
        allowEscapeKey: true,
        allowOutsideClick: true        
    });
