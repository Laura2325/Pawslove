    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // Proceder al pago
        elements.procederPago.addEventListener('click', () => {
            if (Object.keys(cart).length > 0) {
    ...
    // Evento para el avatar de usuario (corregido el selector)
    document.addEventListener('DOMContentLoaded', () => {
        const ingresoUsuario = document.querySelector('a[href="../login.html"]');
        if (ingresoUsuario) {
            ingresoUsuario.addEventListener('click', (e) => {
                e.preventDefault();
